...
## Колір, який використовується для кнопок і смуг, які наводяться.
...
## Рамки #######################################################################
##
## Ці змінні керують виглядом фреймів, що можуть містити компоненти інтерфейсу
...
## Кадр, який використовується як частина екрана пропуску.
...
## Кількість блоків історії діалогів, яку Ren'Py збереже.
define config.history_length = 250

## Висота запису на екрані історії або None, щоб зробити висоту змінною за
## рахунок продуктивності.
define gui.history_height = 210

## Положення, ширина та вирівнювання мітки, яка дає назву персонажа, що
## говорить.
